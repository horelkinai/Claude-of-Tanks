...
| Software | Author | Source | License | Files |
|---|---|---|---|---|
| Cloudflare Workers runtime declarations, generated by Wrangler 4.129.0 / workerd 1.20260903.1 for the private-room signaling Worker. Embedded upstream notices are retained. | Cloudflare and Microsoft Corporation | https://github.com/cloudflare/workerd/tree/main/types / https://developers.cloudflare.com/workers/wrangler/commands/#types | Apache License 2.0; copy at `LICENSES/Apache-2.0.txt` | `cloudflare/signaling/worker-configuration.d.ts` |
