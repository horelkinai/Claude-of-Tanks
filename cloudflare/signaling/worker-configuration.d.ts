/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 737f5e00aa0b3f6f93e4bd7c04aa427c)
// Runtime types generated with workerd@1.20260903.1 2026-09-05 nodejs_compat
// Project modification: trailing whitespace normalized; declarations unchanged.
interface __BaseEnv_Env {
	ROOM_CONNECT_LIMITER: RateLimit;
	ALLOWED_ORIGINS: string;
	ROOMS: DurableObjectNamespace<import("./src/index").PrivateRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PrivateRoom";
	}
